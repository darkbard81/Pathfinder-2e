...
* ⚠️ 위험요소:
  ...
  * 그녀 본인도 파편에 한 차례 노출되었으며, 기억 일부를 잃은 상태
...
* 🧬 종족: *티플링 (불계열)*
* 💋 매력 유형: 지배・위협 속의 흥분, 약한 상처, 짧은 거리
* 🗨️ 말투: 명령조, 속도 느림, 단문. 자주 이름을 불러 재확인.

  > “슬라몬. 무릎. 말해. 파편이—어떻게 죽이는가.”
* ✨ 외형: 피부는 벽돌빛, 금속같은 검은 뿔이 목에서 뒷머리로 휘감김.
  전신은 가죽 포장된 전술복. 입가엔 ‘작은 칼자국 문신’이 있다.
* 🎯 목표: 슬라몬을 심리적으로 굴복시켜, Firebrands가 파편을 무기화하는 데 승인하게 만들기
* 🧪 수단:
...
* ⚠️ 위험요소:
  ...
  * 통제 실패 시, 암살 명령과 교체 전환 가능성 있음
  * 감정 없는 듯 보이나, 복종보다는 투쟁을 바람
